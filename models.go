...
type User struct {
	ID                string     `json:"username" gorm:"type:varchar(64)" binding:"required"`
	Email             string     `json:"email" gorm:"varchar(254)" binding:"required,email"`
	IsEmailVerified   bool       `json:"is_email_verfied" binding:"-"`
	Password          string     `json:"password" gorm:"varchar(256)" binding:"required"`
...
type Wish struct {
	...
	Name        string     `json:"name" gorm:"type:varchar(256)" binding:"required"`
